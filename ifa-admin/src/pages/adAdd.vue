    ...
    <div class="wrapper form_wraper">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="80px" class="form_wraper_inner padding057">
            <el-form-item label="广告位" prop="adPosition">
                <el-select clearable v-model="ruleForm.adPosition" placeholder="广告位">
                    <el-option v-for="(item,index) in dictionaryTable.adList" :key="index" :label="item.dicValue" :value="item.dicCode"></el-option>
                </el-select>
            </el-form-item>
...
import { getAdPositionList, adUpdate } from "@/assets/http/l_http";
